'use client';
/**
 * TKAG-26: Balanced Wellness Hub — Social Share Buttons
 */

import React, { useState } from 'react';
import { buildTwitterShareUrl, buildWhatsAppShareUrl } from '../../utils/blogHelpers';
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.buttons}>
        {/* Twitter / X */}
        <a
          href={buildTwitterShareUrl(shareUrl, title)}
          target="_blank"
        ...
        {/* WhatsApp */}
        <a
          href={buildWhatsAppShareUrl(shareUrl, title)}
          target="_blank"
          rel="noopener noreferrer"
